 ...
 * https://modernizr.com/download/?-getusermedia-webgl-prefixed-setclasses !*/
!function (e, n, t) {
    function r(e, n) {
        return typeof e === n
    }
    ...
    function m(e, t, r, o) {
        var i, a, l, f, u = "modernizr", p = s("div"), d = c();
        if (parseInt(r, 10)) for (; r--;) l = s("div"), l.id = o ? o[r] : u + (r + 1), p.appendChild(l);
        return i = s("style"), i.type = "text/css", i.id = "s" + u, (d.fake ? d : p).appendChild(i), d.appendChild(p), i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(n.createTextNode(e)), p.id = u, d.fake && (d.style.background = "", d.style.overflow = "hidden", f = S.style.overflow, S.style.overflow = "hidden", S.appendChild(d)), a = t(p, e), d.fake ? (d.parentNode.removeChild(d), S.style.overflow = f, S.offsetHeight) : p.parentNode.removeChild(p), !!a
    }
    ...
    function g(e, n, o, i) {
        ...
        for (var p, d, c, m, g, y = ["modernizr", "tspan", "samp"]; !N.style && y.length;) p = !0, N.modElem = s(y.shift()), N.style = N.modElem.style;
        for (c = e.length, d = 0; c > d; d++) if (m = e[d], g = N.style[m], l(m, "-") && (m = a(m)), N.style[m] !== t) {
    ...
    Modernizr.prototype = x, Modernizr = new Modernizr, Modernizr.addTest("getUserMedia", "mediaDevices" in navigator && "getUserMedia" in navigator.mediaDevices);
    var S = n.documentElement, w = "svg" === S.nodeName.toLowerCase();
    Modernizr.addTest("webgl", function () {
        var n = s("canvas"), t = "probablySupportsContext" in n ? "probablySupportsContext" : "supportsContext";
        return t in n ? n[t]("webgl") || n[t]("experimental-webgl") : "WebGLRenderingContext" in e
    });
    var b = "Moz O ms Webkit", _ = x._config.usePrefixes ? b.split(" ") : [];
    x._cssomPrefixes = _;
    var E = function (n) {
    ...
    o(), i(h), delete x.addTest, delete x.addAsyncTest;
